...
public class TencentSmsSender implements SmsSender {
    ...
    public String sender(ServletWebRequest request, String smsTemplate, String[] mobiles, String code) {
        ...
        return sender(request, smsTemplate, mobiles, param);
    }
    ...
    public String sender(ServletWebRequest request, String smsTemplate, String[] mobiles, TreeMap<String, Object> param) {
        ...
        for (Map.Entry<String, Object> v : param.entrySet()) {
            params.add(String.valueOf(v));
        }
        var templateParamSet = params.toArray(new String[params.size()]);
        ...
        try {
            ...
            httpProfile.setEndpoint(smsProperty.getUrl());
            ...
            req.setSmsSdkAppid(smsProperty.getSdkAppId());

            /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
            // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
            String signName = "腾讯云";
            req.setSign(smsProperty.getSignName());

            /* 模板 ID: 必须填写已审核通过的模板 ID */
            // 模板 ID 可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-template) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-template) 的正文模板管理查看
            String templateId = "449739";
            req.setTemplateID(smsTemplate);
