...
public final class OAuth2ConfigurerUtils {
	...
	public static void main(String[] args) {
		String client = "messaging-client:secret";
		var s = Base64.getEncoder().encode(client.getBytes(StandardCharsets.UTF_8));
		System.err.println(new String(s, StandardCharsets.UTF_8));
	}
